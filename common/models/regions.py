# Yoinked from https://github.com/runelite/runelite.net/blob/master/src/_data/regions.js
...
REGION_ID_TO_NAME = {
    ...
    for region_id in location["regions"]
}


def get_location_name(region_id):
    return REGION_ID_TO_NAME.get(region_id, "Unknown")
